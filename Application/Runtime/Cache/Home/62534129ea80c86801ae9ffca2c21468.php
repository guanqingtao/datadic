...
<div class="container">
		<div class="row">
			<div class="col-md-12 "><h1>实时</h1></div>
		</div>
		<div class="table-responsive">
            <table class="table table-bordered" style="word-break:break-all; word-wrap:break-all;">
              ...
              <tbody>
				...
				<?php $n = 1; foreach($result as $key=>$value){ echo "<tr>"; echo "<td width='40'>"; echo $n; echo "</td>"; echo "<td width='100'>"; echo $value['ns']; echo "</td>"; echo "<td  width='50'>"; echo $value['op']; echo "</td>"; echo "<td width='150'>"; if(isset($value['query'])){ if(isset($value['updateobj'])){ $value['query']['updateobj'] = $value['updateobj']; } echo json_encode($value['query']); }else if(isset($value['command'])){ echo json_encode($value['command']); } echo "</td>"; echo "<td width='50' >"; echo $value['millis']."ms"; echo "</td>"; echo "<td width='150' >"; if(isset($value['lockStats'])){ echo json_encode($value['lockStats']); } echo "</td>"; echo "<td width='100' >"; echo $value['client']; echo "</td>"; echo "</tr>"; $n = $n+1; } ?>
              </tbody>
            </table>
          </div>
