...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
		<form class="form-inline" action="<?php echo U('index/validation_post');?>" method='post'>
		  <div class="form-group">
			<label class="sr-only" for="exampleInputAmount">Amount (in dollars)</label>
			<div class="input-group">
			  <div class="input-group-addon"></div>
			  <input type="password" name='amount' class="form-control" id="exampleInputAmount" placeholder="123456">
			  <div class="input-group-addon"></div>
			</div>
		  </div>
